...
public:
  ...
  virtual void do_function_declaration_node(ook::function_declaration_node * const node, int lvl) = 0;
  virtual void do_function_definition_node(ook::function_definition_node * const node, int lvl) = 0;
  ...
  virtual void do_variable_declaration_node(ook::variable_declaration_node * const node, int lvl) = 0;
  virtual void do_null_node(ook::null_node * const node, int lvl) = 0;
  virtual void do_lvalue_index_node(ook::lvalue_index_node * const node, int lvl) = 0;
